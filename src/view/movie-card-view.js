    ...
    `<li class="movies-list__item">
      <article class="movie-card">
        ...
        <div class="movie-card__actions">
          <button class="icon-button icon-button--icon_list-add icon-button--compact" aria-pressed="${isWatchlisted}">
          ...
          <button class="icon-button icon-button--icon_star icon-button--compact" aria-pressed="${isFavorited}">
